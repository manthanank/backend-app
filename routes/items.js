 ...
 *     responses:
 *       200:
 *         description: Item statistics for analytics
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                     minPrice:
 *                       type: number
 *                       description: Minimum price among all items
 *                     maxPrice:
 *                       type: number
 *                       description: Maximum price among all items
 ...
 *                           count:
 *                             type: integer
 *                             description: Number of items with the status
 *                     recentItems:
 *                       type: array
 *                       items:
 *                         type: object
